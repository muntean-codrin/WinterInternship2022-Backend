...
{
    public class LetterReaderSingleton
    {
        private static LetterReaderSingleton singletonInstance;

        public static LetterReaderSingleton GetInstance()
        {
            if(singletonInstance == null)
            {
                singletonInstance = new LetterReaderSingleton();
            }
            return singletonInstance;
        }
        private LetterReaderSingleton()
        {
