...
{
    public class LetterWriterSingleton
    {
        private static LetterWriterSingleton singletonInstance;
        public static LetterWriterSingleton GetInstance()
        {
            if (singletonInstance == null)
            {
                singletonInstance = new LetterWriterSingleton();
            }
            return singletonInstance;
        }

        private LetterWriterSingleton()
        {
